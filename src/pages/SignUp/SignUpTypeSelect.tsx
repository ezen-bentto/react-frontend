        ...
        <div className="flex flex-col justify-center gap-6 sm:flex-row">
          <div className="rounded-2xl border border-gray-200 p-8 shadow-xl transition-all duration-200 hover:scale-105 hover:shadow-2xl dark:border-gray-700">
            ...
            <button
              ...
              className="w-full rounded-lg bg-blue-600 px-6 py-3 text-lg font-semibold text-white transition-all duration-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-gray-600 dark:hover:bg-gray-700"
            >
              개인 회원 가입
            </button>
          </div>
