  ...
  return (
    <div className="p-6 max-w-5xl mx-auto text-gray-800">
      ...
      <div className="text-sm text-gray-600 space-y-1 mb-4">
        <div>
          <span className="font-semibold mr-2">구분</span>공모전
        </div>
        <div>
          <span className="font-semibold mr-2">모집 연령</span>대학생
        </div>
        <div>
          <span className="font-semibold mr-2">일정</span>2025-05-20 ~ 2025-06-20
        </div>
        <div>
          <span className="font-semibold mr-2">모집 종료</span>모집이 종료되었습니다.
        </div>
      </div>
        ...
        <div className="flex space-x-2 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-end mt-2 space-x-2">
              <button className="px-4 py-1 bg-gray-200 rounded hover:bg-gray-300 text-sm">
                취소
              </button>
