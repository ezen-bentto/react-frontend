    ...
    return (
        <form className="max-w-[900px] mx-auto p-8 bg-white rounded-xl shadow" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end gap-3">
                <button type="button" className="px-4 py-2 border rounded text-gray-600">취소</button>
                <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded">등록</button>
            </div>
        </form>
    );
};
