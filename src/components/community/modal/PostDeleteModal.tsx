...
const PostDeleteModal = ({ isOpen, message, onCancel, onConfirm }: RepusetModalProps) => {
    if (!isOpen) return null;

    return (
        <dialog id="delete_modal" className="modal backdrop:bg-black backdrop:bg-opacity-50" open>
